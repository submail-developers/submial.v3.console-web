import { Input, Space, Row, Col, Flex, Pagination, Button } from 'antd'
...
export default function Fn() {
  ...
  const [refresh, setrefresh] = useState(1) // 待刷新素材数量
  ...
  return (
    <div className='rcs-temp-meteial'>
      ...
      <div
        className='rcs-meteial-list p-x-16 p-b-16'
        style={{
          height: `calc(100% - ${
      ...
      <div className='float-btm'>
        ...
        {refresh > 0 && (
          <Space className='p-x-16 p-y-8 m-b-8 refresh-wrap'>
            <div>
              <div className='fw-500'>87个素材即将到期</div>
